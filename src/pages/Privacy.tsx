    ...
    <section className="py-12 md:py-16">
      <div className="container">
        <header className="mb-6">
          <h1 className="font-heading text-3xl md:text-5xl tracking-tight">Privacy Policy</h1>
          <p className="mt-2 text-muted-foreground">The policy below is sourced from our canonical Notion page.</p>
        </header>
        <div className="rounded-2xl border border-border overflow-hidden bg-card">
          <div className="aspect-[16/12] md:aspect-[16/9]">
            <iframe
              src={notionUrl}
              title="Privacy Policy — Notion"
